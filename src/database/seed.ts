...
async function main() {
    ...
    await db.insert(schema.search_history).values([
        { student_id: 100, search_query: 'frontend developer react hcm', filters: { city: 'Hồ Chí Minh', experience_level: 'Junior' }, results_count: 5 },
        { student_id: 100, search_query: 'full-stack nodejs junior', filters: { salary_min: 15000000 }, results_count: 8 },
        { student_id: 100, search_query: 'backend engineer golang fintech', filters: { city: 'Hồ Chí Minh' }, results_count: 3 },
        ...
        { student_id: 101, search_query: 'machine learning engineer', filters: { city: 'Hồ Chí Minh' }, results_count: 3 },
    ...
    await db.insert(schema.saved_searches).values([
        { student_id: 100, search_name: 'React/Node Jobs HCM', search_query: 'react nodejs developer', filters: { city: 'Hồ Chí Minh' }, is_alert_enabled: true },
        ...
        { student_id: 100, search_name: 'Full-stack Product Company', search_query: 'full-stack software engineer', filters: { city: 'Hồ Chí Minh', salary_min: 18000000 }, is_alert_enabled: false },
