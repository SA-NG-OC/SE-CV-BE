...
const CV_NVA_FULLSTACK = 'https://www.orimi.com/pdf-test.pdf';
const CV_NVA_BACKEND = 'https://pdfobject.com/pdf/sample.pdf';
const CV_NVA_FRONTEND = 'https://www.orimi.com/pdf-test.pdf';
const CV_TTB_AI = 'https://pdfobject.com/pdf/sample.pdf';
const CV_LVC_MOBILE = 'https://css4.pub/2015/usenix/example.pdf';
const CV_PTD_BA = 'https://pdfobject.com/pdf/sample.pdf';
const CV_HVE_DEVOPS = 'https://pdfobject.com/pdf/sample.pdf';
...
const CV_BVI_DATA = 'https://www.soundczech.cz/temp/lorem-ipsum.pdf';
const CV_DTJ_SWE =
...
const APP_100_CV =
  'https://unec.edu.az/application/uploads/2014/12/pdf-sample.pdf';
const APP_101_CV = 'https://www.soundczech.cz/temp/lorem-ipsum.pdf';
const APP_102_CV = 'https://www.orimi.com/pdf-test.pdf';
const APP_103_CV = 'https://pdfobject.com/pdf/sample.pdf';
const APP_104_CV =
  'https://www.cs.cmu.edu/~quake-papers/painless-conjugate-gradient.pdf';
const APP_105_CV = 'https://css4.pub/2015/usenix/example.pdf';
const APP_106_CV = 'https://pdfobject.com/pdf/sample.pdf';
const APP_107_CV =
  'https://www.rd.usda.gov/sites/default/files/pdf-sample_0.pdf';
const APP_108_CV =
  'https://freetestdata.com/wp-content/uploads/2021/09/Free_Test_Data_100KB_PDF.pdf';
const APP_109_CV = 'https://www.soundczech.cz/temp/lorem-ipsum.pdf';
const APP_110_CV = 'https://www.soundczech.cz/temp/lorem-ipsum.pdf';
const APP_111_CV = 'https://pdfobject.com/pdf/sample.pdf';
const APP_112_CV = 'https://www.bls.gov/cps/aa2010/cpsaat11.pdf';
// ─────────────────────────────────────────────────────────────────────────────
...
async function main() {
  ...
  await db.insert(schema.users).values([
    // Admin
    {
      ...
      password_hash:
        '$2a$10$IQHd4uBdkCS7hoV4uVDI1OCfW7aq.3kCd6ca4ZeqfCJkTniPRp5lO',
      role_id: 1,
      is_active: true,
      is_verified: true,
    },
    ...
    // Companies
    {
      ...
      password_hash:
        '$2a$10$BukqDjmK.Nc.AMG8yZxN6O8mqPR/s5fmq8ZMFNiEXYIL5lJMsb8Jm',
      role_id: 2,
      is_active: true,
      is_verified: true,
    },
    {
      ...
      password_hash:
        '$2b$10$z4alfCAmpcYnmDZMi/9g6ewB0NdDBvHODzqsJ27pOK9uHQGnXr.ja',
      role_id: 2,
      is_active: true,
      is_verified: true,
    ...
    // Students
    {
      ...
      password_hash:
        '$2a$10$xe9KZlyOBaigKLeFpJomZ.gLhDTIVt9jsSaL9/iRttPSqwjpfoSiW',
      role_id: 3,
      is_active: true,
      is_verified: true,
    },
    {
      ...
      role_id: null,
      oauth_provider: 'google',
      oauth_provider_id: '102693512867141333079',
    },
    {
      user_id: 100,
  ...
  await db.insert(schema.companies).values([
    {
      ...
      description:
        'Công ty phát triển phần mềm hàng đầu tại Việt Nam, chuyên cung cấp các giải pháp công nghệ cho doanh nghiệp.',
    ...
    },
    {
      ...
      cover_image_url: UIT_LOGO,
      description:
        'FPT Software là công ty cung cấp dịch vụ và giải pháp công nghệ thông tin hàng đầu tại Việt Nam và thế giới.',
    ...
    },
    {
      ...
      cover_image_url: UIT_LOGO,
      description:
        'VNG là tập đoàn công nghệ hàng đầu Việt Nam, nổi tiếng với Zalo và các sản phẩm game trực tuyến.',
      address: '182 Lê Đại Hành, Phường 15, Quận 11, Hồ Chí Minh',
    ...
    },
    {
      ...
      cover_image_url: UIT_LOGO,
      description:
        'Tiki là nền tảng thương mại điện tử hàng đầu Việt Nam, cung cấp hàng triệu sản phẩm đến tay người tiêu dùng.',
      address: '52 Út Tịch, Phường 4, Quận Tân Bình, Hồ Chí Minh',
    ...
    },
    {
      ...
      cover_image_url: UIT_LOGO,
      description:
        'MoMo là ví điện tử và siêu ứng dụng thanh toán số 1 tại Việt Nam với hơn 31 triệu người dùng.',
      address: '178/10 Nguyễn Văn Thương, Phường 25, Bình Thạnh, Hồ Chí Minh',
    ...
    },
    {
      ...
      cover_image_url: UIT_LOGO,
      description:
        'Startup công nghệ trẻ tập trung vào giải pháp SaaS cho doanh nghiệp vừa và nhỏ tại Đông Nam Á.',
  ...
  await db.insert(schema.students).values([
    {
      ...
      career_goals:
        'Trở thành Full-stack Developer tại công ty công nghệ hàng đầu.',
  ...
  await db.insert(schema.student_resumes).values([
    {
      student_id: 100,
      resume_name: 'CV Nguyễn Văn A - Full-stack 2026',
      cv_url: CV_NVA_FULLSTACK,
      is_default: true,
    },
    {
      student_id: 101,
      resume_name: 'CV Trần Thị B - AI Engineer 2026',
      cv_url: CV_TTB_AI,
      is_default: true,
    },
    {
      student_id: 102,
      resume_name: 'CV Lê Văn C - Mobile Dev',
      cv_url: CV_LVC_MOBILE,
      is_default: true,
    },
    {
      student_id: 103,
      resume_name: 'CV Phạm Thị D - BA/Data Analyst',
      cv_url: CV_PTD_BA,
      is_default: true,
    },
    {
      student_id: 104,
      resume_name: 'CV Hoàng Văn E - DevOps',
      cv_url: CV_HVE_DEVOPS,
      is_default: true,
    },
    {
      student_id: 105,
      resume_name: 'CV Ngô Thị F - Frontend',
      cv_url: CV_NTF_FRONTEND,
      is_default: true,
    },
    {
      student_id: 106,
      resume_name: 'CV Đinh Văn G - Backend Java',
      cv_url: CV_DVG_BACKEND,
      is_default: true,
    },
    {
      student_id: 107,
      resume_name: 'CV Vũ Thị H - Intern',
      cv_url: CV_VTH_INTERN,
      is_default: true,
    },
    {
      student_id: 108,
      resume_name: 'CV Bùi Văn I - Data Analyst',
      cv_url: CV_BVI_DATA,
      is_default: true,
    },
    {
      student_id: 109,
      resume_name: 'CV Đỗ Thị J - Software Engineer',
      cv_url: CV_DTJ_SWE,
      is_default: true,
    },
    ...
    {
      student_id: 100,
      resume_name: 'CV Nguyễn Văn A - Backend Focus',
      cv_url: CV_NVA_BACKEND,
      is_default: false,
    },
    {
      student_id: 100,
      resume_name: 'CV Nguyễn Văn A - Frontend Specialist',
      cv_url: CV_NVA_FRONTEND,
      is_default: false,
    },
  ]);
  ...
  await db.insert(schema.job_postings).values([
    // --- Tech Solutions Vietnam (company_id: 100) — tài khoản company@test.com ---
    {
      ...
      job_description:
        'Chúng tôi tìm kiếm Frontend Developer có kinh nghiệm với React để xây dựng các ứng dụng web hiện đại, hiệu suất cao cho khách hàng doanh nghiệp trong và ngoài nước.',
      requirements:
    ...
    },
    {
      ...
      job_description:
        'Tìm kiếm Backend Developer Node.js để xây dựng và duy trì các API microservices, tích hợp hệ thống và đảm bảo hiệu suất cho nền tảng SaaS của chúng tôi.',
      requirements:
        '- Tối thiểu 1 năm kinh nghiệm với Node.js\n- Hiểu biết về RESTful API, GraphQL\n- Kinh nghiệm với PostgreSQL hoặc MongoDB\n- Biết về Docker là lợi thế\n- Có tư duy về bảo mật ứng dụng',
      benefits:
        '- Lương 14-22 triệu VNĐ\n- Review lương 6 tháng/lần\n- Laptop được cấp\n- Phụ cấp ăn trưa, xăng xe\n- Team building hàng quý',
      experience_level: 'Junior',
      position_level: 'Nhân viên',
      number_of_positions: 2,
      salary_min: 14000000,
    ...
    },
    {
      ...
      job_description:
        'Chúng tôi cần một UI/UX Designer sáng tạo để thiết kế trải nghiệm người dùng tuyệt vời cho các sản phẩm web và mobile.',
      requirements:
      ...
      application_count: 0,
      admin_notes:
        'Mô tả công việc chưa đủ chi tiết, yêu cầu công ty bổ sung portfolio requirements.',
    },
    {
      job_id: 103,
      company_id: 100,
      ...
      job_description:
        'Tech Solutions Vietnam tuyển Full-stack Developer để tham gia phát triển các sản phẩm SaaS cho khách hàng doanh nghiệp.',
      requirements:
        '- Tối thiểu 1 năm kinh nghiệm Full-stack\n- Thành thạo React (Frontend)\n- Thành thạo Node.js (Backend)\n- Kinh nghiệm với PostgreSQL\n- Biết Docker là lợi thế',
      benefits:
        '- Lương 15-25 triệu VNĐ\n- Remote-friendly\n- Thưởng dự án hấp dẫn\n- Laptop được cấp\n- Văn phòng Quận 1, Hồ Chí Minh',
      experience_level: 'Junior',
      position_level: 'Nhân viên',
    ...
    },
    {
      ...
      job_description:
        'Tech Solutions Vietnam cần DevOps Engineer để xây dựng và vận hành hạ tầng CI/CD, quản lý cloud infrastructure cho các sản phẩm của công ty.',
      requirements:
    ...
    // --- FPT Software (company_id: 101) ---
    {
      ...
      job_description:
        'FPT Software tuyển dụng Java Developer tham gia vào các dự án outsourcing cho khách hàng Nhật Bản và Mỹ.',
      requirements:
        '- Tốt nghiệp hoặc chuẩn bị tốt nghiệp ngành CNTT\n- Nắm vững Java OOP, Java Core\n- Biết Spring Boot cơ bản\n- Có kiến thức SQL\n- Tiếng Anh đọc hiểu tài liệu',
      benefits:
        '- Lương Fresher: 8-12 triệu, Junior: 12-20 triệu\n- Đào tạo nội bộ chuyên sâu\n- Cơ hội đi làm dự án nước ngoài\n- Môi trường quốc tế',
    ...
    },
    {
      ...
      job_description:
        'Tuyển Data Engineer để xây dựng và vận hành data pipeline, data warehouse phục vụ các dự án phân tích dữ liệu lớn.',
      requirements:
        '- Tối thiểu 1 năm kinh nghiệm với Python\n- Biết Apache Spark, Kafka hoặc tương đương\n- Kinh nghiệm với SQL và NoSQL\n- Hiểu biết về Cloud (AWS/GCP/Azure)\n- Kinh nghiệm ETL pipeline',
      benefits:
    ...
    },
    {
      ...
      job_description:
        'Tuyển Mobile Developer sử dụng Flutter để phát triển ứng dụng đa nền tảng cho các khách hàng quốc tế của FPT.',
      requirements:
        '- Tối thiểu 1 năm kinh nghiệm Flutter/Dart\n- Hiểu về State Management (Bloc, Provider)\n- Biết tích hợp REST API\n- Kinh nghiệm publish app lên Store\n- Biết native (Swift/Kotlin) là lợi thế',
      benefits:
    ...
    // --- VNG Corporation (company_id: 102) ---
    {
      ...
      job_description:
        'VNG tìm kiếm Backend Engineer tham gia phát triển hệ thống Zalo với quy mô hàng chục triệu người dùng.',
      requirements:
    ...
    // --- Tiki Corporation (company_id: 103) ---
    {
      ...
      job_description:
        'Tiki tìm kiếm Software Engineer để xây dựng và phát triển các tính năng mới trên nền tảng e-commerce, phục vụ hàng triệu đơn hàng mỗi ngày.',
      requirements:
    ...
    },
    {
      ...
      job_description:
        'Tiki tìm Product Designer cấp cao để dẫn dắt thiết kế sản phẩm cho các tính năng chiến lược, xây dựng Design System và mentoring team designer.',
      requirements:
        '- Tối thiểu 3 năm kinh nghiệm Product Design\n- Portfolio mạnh với case study chi tiết\n- Thành thạo Figma, Principle\n- Kinh nghiệm xây dựng Design System\n- Kỹ năng giao tiếp và thuyết trình tốt',
      benefits:
    ...
    // --- MoMo (company_id: 104) ---
    {
      ...
      job_description:
        'MoMo tuyển Backend Engineer Golang để xây dựng các service thanh toán, ví điện tử và hệ thống tài chính yêu cầu độ tin cậy và bảo mật cao.',
      requirements:
        '- Tối thiểu 1 năm kinh nghiệm Golang\n- Hiểu về payment system, transaction\n- Kinh nghiệm microservices, gRPC\n- Biết về security trong ứng dụng tài chính\n- Kinh nghiệm Redis, PostgreSQL',
      benefits:
  ...
  await db.insert(schema.job_required_skills).values([
    ...
    { job_id: 100, skill_id: 100 },
    { job_id: 100, skill_id: 102 },
    { job_id: 100, skill_id: 113 },
    { job_id: 101, skill_id: 101 },
    { job_id: 101, skill_id: 102 },
    { job_id: 101, skill_id: 109 },
    { job_id: 101, skill_id: 112 },
    { job_id: 102, skill_id: 119 },
    { job_id: 103, skill_id: 100 },
    { job_id: 103, skill_id: 101 },
    { job_id: 103, skill_id: 102 },
    { job_id: 104, skill_id: 106 },
    { job_id: 104, skill_id: 107 },
    { job_id: 104, skill_id: 108 },
    // FPT jobs (105–107)
    { job_id: 105, skill_id: 104 },
    { job_id: 105, skill_id: 105 },
    { job_id: 105, skill_id: 109 },
    { job_id: 106, skill_id: 103 },
    { job_id: 106, skill_id: 108 },
    { job_id: 106, skill_id: 109 },
    { job_id: 106, skill_id: 110 },
    { job_id: 107, skill_id: 114 },
    // VNG jobs (108–109)
    { job_id: 108, skill_id: 103 },
    { job_id: 108, skill_id: 111 },
    { job_id: 109, skill_id: 103 },
    { job_id: 109, skill_id: 117 },
    // Tiki jobs (110–112)
    { job_id: 110, skill_id: 100 },
    { job_id: 110, skill_id: 101 },
    { job_id: 110, skill_id: 109 },
    { job_id: 110, skill_id: 111 },
    { job_id: 111, skill_id: 103 },
    { job_id: 111, skill_id: 109 },
    { job_id: 111, skill_id: 118 },
    { job_id: 112, skill_id: 119 },
    // MoMo jobs (113–115)
    { job_id: 113, skill_id: 109 },
    { job_id: 113, skill_id: 111 },
    { job_id: 114, skill_id: 103 },
    { job_id: 114, skill_id: 117 },
    { job_id: 114, skill_id: 118 },
    { job_id: 115, skill_id: 116 },
    // Startup XYZ jobs (116–117)
    { job_id: 116, skill_id: 100 },
    { job_id: 116, skill_id: 101 },
    { job_id: 116, skill_id: 102 },
    { job_id: 117, skill_id: 103 },
    { job_id: 117, skill_id: 117 },
  ]);
  ...
  await db.insert(schema.applications).values([
    // ===== TÀI KHOẢN CHÍNH: student_id 100 (nguyenvana@student.edu.vn) =====
    {
      ...
      cv_url: APP_100_CV,
      cover_letter:
        'Kính chào Tech Solutions Vietnam, tôi là Nguyễn Văn A, sinh viên tốt nghiệp ngành CNTT. Với kinh nghiệm 2 năm với React và Node.js, tôi rất tự tin có thể đóng góp ngay từ đầu vào team Frontend của quý công ty.',
      status: 'submitted',
    ...
    },
    {
      ...
      cv_url: APP_101_CV,
      cover_letter:
        'Tôi muốn ứng tuyển vị trí Backend Developer (Node.js) tại Tech Solutions Vietnam. Tôi có kinh nghiệm xây dựng REST API và GraphQL, đồng thời thành thạo PostgreSQL và MongoDB.',
      status: 'interviewing',
    ...
    },
    {
      ...
      cv_url: APP_102_CV,
      cover_letter:
        'Tôi rất hứng thú với vị trí Software Engineer (Full-stack) tại Tiki. Với kỹ năng React và Node.js, tôi tin mình có thể đóng góp vào các sản phẩm e-commerce phục vụ hàng triệu người dùng.',
      status: 'passed',
    ...
    },
    {
      ...
      cv_url: APP_103_CV,
      cover_letter:
        'Tôi muốn ứng tuyển vị trí Backend Engineer tại VNG. Dù background chính là Full-stack, tôi rất đam mê backend và distributed systems. Sản phẩm Zalo là nguồn cảm hứng lớn để tôi phát triển.',
      status: 'interviewing',
    ...
    },
    {
      ...
      cv_url: APP_104_CV,
      cover_letter:
        'Tôi rất quan tâm đến vị trí Backend Engineer tại MoMo. Tôi đang học Golang và có nền tảng vững về backend. Tôi tin rằng môi trường Fintech sẽ giúp tôi phát triển nhanh hơn.',
      status: 'submitted',
    ...
    },
    {
      ...
      cv_url: APP_105_CV,
      cover_letter:
        'Tôi muốn thử sức với vị trí DevOps tại Tech Solutions Vietnam. Tôi đã có kinh nghiệm cơ bản với Docker và đang học Kubernetes.',
      status: 'rejected',
    ...
    },
    {
      ...
      cv_url: APP_106_CV,
      cover_letter:
        'Tôi ứng tuyển vị trí Data Analyst tại Tiki. Dù thế mạnh chính là lập trình, tôi cũng có kiến thức SQL và Python phân tích dữ liệu từ các dự án cá nhân.',
      status: 'submitted',
    ...
    // ===== DỮ LIỆU NỀN: các student khác =====
    {
      ...
      cv_url: APP_107_CV,
      cover_letter:
        'Với kinh nghiệm Python và Data Engineering, tôi tin mình phù hợp với vị trí này tại FPT.',
      status: 'submitted',
    ...
    },
    {
      ...
      cv_url: APP_110_CV,
      cover_letter:
        'Tôi quan tâm đến Fintech và muốn đóng góp cho hệ thống thanh toán của MoMo.',
      status: 'passed',
    ...
    },
    {
      ...
      cv_url: APP_111_CV,
      cover_letter:
        'Tôi thành thạo SQL và Python cho data analysis, đã có kinh nghiệm thực tế với Power BI.',
      status: 'passed',
    ...
    },
    {
      ...
      cv_url: APP_112_CV,
      cover_letter:
        'Với kỹ năng phân tích dữ liệu và SQL nâng cao, tôi phù hợp với vị trí Data Analyst tại Tiki.',
      status: 'interviewing',
  ...
  await db.insert(schema.job_views).values([
    {
      ...
      viewed_at: new Date('2026-04-08'),
    },
    {
      job_id: 101,
      student_id: 100,
      ip_address: '192.168.1.1',
      viewed_at: new Date('2026-03-12'),
    },
    {
      job_id: 108,
      student_id: 100,
      ip_address: '192.168.1.1',
      viewed_at: new Date('2026-05-20'),
    },
    {
      job_id: 113,
      student_id: 100,
      ip_address: '192.168.1.1',
      viewed_at: new Date('2026-05-21'),
    },
    {
      job_id: 110,
      student_id: 100,
      ip_address: '192.168.1.1',
      viewed_at: new Date('2026-05-23'),
    },
    {
      job_id: 109,
      student_id: 100,
      ip_address: '192.168.1.1',
      viewed_at: new Date('2026-05-24'),
    },
    {
      job_id: 104,
      student_id: 100,
      ip_address: '192.168.1.1',
      viewed_at: new Date('2026-01-08'),
    },
    {
      job_id: 111,
      student_id: 100,
      ip_address: '192.168.1.1',
      viewed_at: new Date('2026-05-15'),
    },
    {
      job_id: 109,
      student_id: 101,
      ip_address: '192.168.1.2',
      viewed_at: new Date('2026-05-19'),
    },
    {
      job_id: 108,
      student_id: 104,
    ...
    },
    {
      ...
      viewed_at: new Date('2026-05-25'),
    },
    {
      job_id: 100,
      student_id: null,
      ip_address: '14.225.10.1',
      viewed_at: new Date('2026-05-26'),
    },
    {
      job_id: 105,
      student_id: null,
      ip_address: '14.225.10.2',
      viewed_at: new Date('2026-05-27'),
    },
    {
      job_id: 108,
      student_id: null,
      ip_address: '14.225.10.3',
      viewed_at: new Date('2026-05-27'),
    },
  ]);
  ...
  await db.insert(schema.comments).values([
    {
      ...
      rating: 5,
      content:
        'Tech Solutions Vietnam có môi trường làm việc rất thoải mái và chuyên nghiệp. Team thân thiện, mentor nhiệt tình. Rất phù hợp cho fresh grad muốn phát triển kỹ năng Full-stack!',
    },
    {
      student_id: 100,
      company_id: 103,
      rating: 4,
      content:
        'Tiki có quy trình tuyển dụng rõ ràng và chuyên nghiệp. Phỏng vấn kỹ thuật khá thử thách nhưng công bằng. Phúc lợi tốt, đặc biệt là bữa trưa miễn phí và giảm giá mua hàng.',
    },
    {
      student_id: 100,
      company_id: 102,
      rating: 5,
      content:
        'VNG là nơi tuyệt vời để học hỏi về hệ thống quy mô lớn. Kỹ sư rất giỏi và sẵn lòng chia sẻ kiến thức. Codebase và kiến trúc rất ấn tượng, phỏng vấn khó nhưng xứng đáng!',
    },
    {
      student_id: 100,
      company_id: 104,
      rating: 4,
      content:
        'MoMo có tech stack hiện đại và bài toán Fintech rất thú vị. Đội ngũ chuyên nghiệp, văn phòng Bình Thạnh đẹp. Lương cạnh tranh, chế độ tốt. Recommend cho ai thích Fintech!',
    },
    {
      student_id: 101,
      company_id: 101,
      rating: 4,
      content:
        'FPT Software đào tạo rất bài bản, phù hợp với sinh viên mới ra trường muốn học hỏi.',
    },
    {
      student_id: 109,
      company_id: 102,
      rating: 5,
      content:
        'Môi trường làm việc tuyệt vời tại VNG, team kỹ sư rất giỏi. Thực tập 2024 là trải nghiệm đáng nhớ nhất!',
    },
    {
      student_id: 108,
      company_id: 103,
      rating: 3,
      content:
        'Tiki ổn nhưng áp lực khá cao, deadline gấp. Phúc lợi tốt nhưng cần cân bằng work-life hơn.',
    },
  ]);
  ...
  await db.insert(schema.job_invitations).values([
    {
      ...
      student_id: 100,
      message:
        'Chào Nguyễn Văn A, chúng tôi đã xem hồ sơ của bạn và rất ấn tượng với kinh nghiệm Full-stack. Tech Solutions Vietnam muốn mời bạn cân nhắc vị trí DevOps Engineer của chúng tôi. Đây là cơ hội tốt để bạn mở rộng kỹ năng sang infrastructure!',
      status: 'accepted',
    },
    {
      invitation_id: 101,
      ...
      student_id: 100,
      message:
        'Chào Nguyễn Văn A, VNG Corporation đã xem xét hồ sơ của bạn và thấy rất phù hợp với vị trí Backend Engineer. Chúng tôi muốn mời bạn ứng tuyển chính thức. Hệ thống Zalo sẽ là môi trường tuyệt vời để bạn phát triển!',
      status: 'accepted',
    },
    {
      invitation_id: 102,
      ...
      student_id: 100,
      message:
        'Hi Văn A, Tiki muốn mời bạn ứng tuyển vị trí Software Engineer (Full-stack). Profile React + Node.js của bạn rất phù hợp với stack của chúng tôi. Join Tiki để cùng xây dựng nền tảng e-commerce số 1 Việt Nam nhé!',
      status: 'accepted',
    },
    {
      invitation_id: 103,
      ...
      student_id: 100,
      message:
        'Xin chào Nguyễn Văn A, MoMo đang tìm kiếm Backend Engineer tài năng. Chúng tôi thấy bạn có nền tảng backend vững chắc và tinh thần học hỏi tốt. Dù bạn chưa có kinh nghiệm Golang, chúng tôi sẵn sàng đào tạo nếu bạn có đam mê!',
      status: 'pending',
    },
    {
      invitation_id: 104,
      ...
      student_id: 100,
      message:
        'Chào Văn A, ngoài vị trí Frontend bạn đã ứng tuyển, chúng tôi cũng mở vị trí Full-stack Developer mới. Với kinh nghiệm của bạn, chúng tôi nghĩ bạn sẽ fit tốt hơn với role này. Bạn có muốn cân nhắc không?',
      status: 'pending',
    },
    {
      invitation_id: 105,
      ...
      student_id: 100,
      message:
        'Chào Nguyễn Văn A, FPT Software mời bạn ứng tuyển vị trí Java Developer. Chúng tôi có chương trình đào tạo tốt cho Fresher!',
      status: 'rejected',
    },
  ]);
  ...
  await db.insert(schema.messages).values([
    // ===== Conv 100: Tech Solutions (2000) ↔ Nguyễn Văn A (100) =====
    {
      ...
      sender_id: 2000,
      content:
        'Chào Nguyễn Văn A, cảm ơn bạn đã ứng tuyển vị trí Frontend Developer tại Tech Solutions Vietnam! Chúng tôi đã xem CV của bạn và rất ấn tượng. Bạn có thể cho chúng tôi biết thêm về dự án React lớn nhất bạn từng thực hiện không?',
    ...
    },
    {
      ...
      sender_id: 100,
      content:
        'Chào anh/chị, cảm ơn đã liên hệ! Dự án lớn nhất của em là hệ thống quản lý kho hàng real-time cho một doanh nghiệp vừa, sử dụng React + Redux Toolkit ở frontend, Node.js + Socket.io ở backend. Hệ thống xử lý được ~500 giao dịch/phút. Em có thể gửi demo link nếu anh/chị muốn xem.',
    ...
    },
    {
      ...
      sender_id: 2000,
      content:
        'Nghe rất ấn tượng! Vui lòng gửi link demo và GitHub repo nhé. Chúng tôi muốn review code trước khi schedule phỏng vấn kỹ thuật. Dự kiến phỏng vấn vào tuần tới, bạn có thể tham gia không?',
    ...
    },
    {
      ...
      sender_id: 100,
      content:
        'Dạ, em xin gửi link: Demo: https://warehouse-demo.vercel.app | GitHub: https://github.com/nguyenvana/warehouse-app. Em hoàn toàn available tuần tới, anh/chị có thể arrange lịch bất kỳ ngày nào từ thứ 2 đến thứ 6 nhé!',
    ...
    },
    {
      ...
      sender_id: 2000,
      content:
        'Cảm ơn bạn! Chúng tôi đã review code và rất đánh giá cao cách bạn tổ chức component và quản lý state. Chúng tôi muốn mời bạn phỏng vấn kỹ thuật vào thứ Tư 22/04 lúc 10h00 tại văn phòng (123 Nguyễn Huệ, Q1). Bạn xác nhận được không?',
    ...
    },
    {
      ...
      sender_id: 100,
      content:
        'Dạ em xác nhận tham gia phỏng vấn vào thứ Tư 22/04 lúc 10h00 ạ. Anh/chị có thể cho em biết vòng phỏng vấn sẽ bao gồm những gì để em chuẩn bị tốt hơn không?',
    ...
    },
    {
      ...
      sender_id: 2000,
      content:
        'Phỏng vấn gồm 2 phần: (1) Technical ~60 phút — coding, system design cơ bản, hỏi về React/Node.js; (2) Culture fit với Team Lead ~30 phút. Bạn nhớ mang laptop nhé. Chúc bạn phỏng vấn tốt!',
    ...
    },
    {
      ...
      sender_id: 2000,
      content:
        'Chào Văn A, sau khi phỏng vấn, team chúng tôi đánh giá rất tích cực về bạn! Chúng tôi muốn offer bạn vị trí Backend Developer (Node.js) với mức lương 18 triệu VNĐ/tháng, review sau 3 tháng. Bạn có thể cho chúng tôi biết suy nghĩ trong vòng 3 ngày không?',
    ...
    // ===== Conv 101: VNG (2001) ↔ Nguyễn Văn A (100) =====
    {
      ...
      sender_id: 2001,
      content:
        'Chào Nguyễn Văn A, VNG đã nhận được đơn ứng tuyển Backend Engineer của bạn. Chúng tôi muốn mời bạn tham gia vòng test online trước. Link test sẽ được gửi vào email trong 24h tới.',
    ...
    },
    {
      ...
      sender_id: 100,
      content:
        'Cảm ơn VNG đã liên hệ! Em rất hào hứng với cơ hội này. Em sẽ chú ý email và hoàn thành bài test đúng hạn ạ.',
    ...
    },
    {
      ...
      sender_id: 2001,
      content:
        'Bạn đã hoàn thành bài test rất tốt! Chúng tôi muốn mời bạn lên phỏng vấn onsite tại văn phòng VNG (182 Lê Đại Hành, Q11) vào thứ Năm 19/03 lúc 14h. Phỏng vấn gồm technical round với 2 senior engineer và system design round.',
    ...
    },
    {
      ...
      sender_id: 100,
      content:
        'Dạ em xác nhận ạ! Em sẽ có mặt lúc 14h thứ Năm 19/03. Cảm ơn VNG rất nhiều vì cơ hội tuyệt vời này!',
    ...
    // ===== Conv 102: Tiki (2002) ↔ Nguyễn Văn A (100) =====
    {
      ...
      sender_id: 2002,
      content:
        'Hi Văn A! Tiki đã xem xét hồ sơ và muốn thông báo bạn đã pass vòng CV screening. Chúc mừng! Bước tiếp theo là vòng technical interview. Bạn available vào tuần tới không?',
    ...
    },
    {
      ...
      sender_id: 100,
      content:
        'Cảm ơn Tiki! Em rất vui khi biết mình pass vòng CV. Em hoàn toàn available tuần tới, anh/chị cứ arrange lịch nhé ạ.',
    ...
    },
    {
      ...
      sender_id: 2002,
      content:
        'Tuyệt! Chúng tôi đã cân nhắc kỹ và muốn offer bạn vị trí Software Engineer với mức 22 triệu/tháng, kèm stock options sau 1 năm. Thời gian bắt đầu linh hoạt. Bạn có muốn thảo luận thêm không?',
    ...
    // ===== Conv 103: MoMo (2003) ↔ Nguyễn Văn A (100) =====
    {
      ...
      sender_id: 2003,
      content:
        'Chào Nguyễn Văn A, MoMo đã nhận đơn ứng tuyển Backend Engineer Golang của bạn. Dù bạn chưa có nhiều kinh nghiệm Golang, chúng tôi thấy nền tảng backend của bạn rất tốt. Bạn có thể chia sẻ về kinh nghiệm làm việc với RESTful API và database của mình không?',
    ...
    },
    {
      ...
      sender_id: 100,
      content:
        'Cảm ơn MoMo đã xem xét đơn của em! Em đã xây dựng nhiều REST API với Node.js, có kinh nghiệm với PostgreSQL và MongoDB. Em cũng tự học Golang được 2 tháng và đã build một số CLI tools. Em rất hứng thú với bài toán payment system của MoMo!',
    ...
    },
    {
      ...
      sender_id: 2003,
      content:
        'Cảm ơn bạn đã chia sẻ! Tinh thần tự học Golang rất đáng khích lệ. Chúng tôi sẽ review và liên hệ lại trong 1 tuần tới nhé.',
  ...
  await db.insert(schema.notifications).values([
    // ===== Thông báo cho Nguyễn Văn A (user_id: 100) =====
    {
      ...
      message:
        'Đơn ứng tuyển Backend Developer (Node.js) của bạn đã được chuyển sang trạng thái Phỏng vấn. Kiểm tra tin nhắn để biết thêm chi tiết!',
    ...
    },
    {
      ...
      message:
        'Tiki Corporation xác nhận bạn đã vượt qua tất cả các vòng phỏng vấn cho vị trí Software Engineer. Tiki sẽ sớm gửi offer letter cho bạn!',
      link: '/applications/102',
      is_read: true,
    },
    {
      user_id: 100,
      ...
      message:
        'Đơn ứng tuyển vị trí DevOps Engineer tại Tech Solutions Vietnam chưa phù hợp lần này. Đừng nản lòng, hãy thử các vị trí phù hợp hơn!',
      link: '/applications/105',
      is_read: true,
    },
    {
      user_id: 100,
      ...
      message:
        'VNG Corporation mời bạn ứng tuyển vị trí Backend Engineer (Go/Python). Đây là cơ hội tuyệt vời để làm việc với hệ thống triệu người dùng!',
      link: '/invitations/101',
      is_read: true,
    },
    {
      user_id: 100,
      ...
      message:
        'MoMo (M_Service) mời bạn ứng tuyển vị trí Backend Engineer Golang. Xem chi tiết và phản hồi ngay!',
      link: '/invitations/103',
      is_read: false,
    },
    {
      user_id: 100,
      ...
      message:
        'Bạn có tin nhắn quan trọng từ Tech Solutions Vietnam về offer thư. Đừng bỏ lỡ!',
      link: '/conversations/100',
      is_read: false,
    },
    {
      user_id: 100,
      ...
      message:
        'Tiki Corporation vừa gửi thông tin về offer lương. Kiểm tra ngay!',
      link: '/conversations/102',
      is_read: false,
    },
    {
      user_id: 100,
      ...
      message:
        'Dựa trên kỹ năng React và Node.js của bạn, hệ thống tìm thấy 5 vị trí Full-stack/Backend mới từ các công ty hàng đầu. Xem ngay!',
      link: '/jobs?skills=react,nodejs',
      is_read: false,
    },
    ...
    // ===== Thông báo cho company@test.com (user_id: 2000) =====
    {
      ...
      message:
        'Admin đã duyệt tin tuyển dụng Frontend Developer (React). Tin đang được hiển thị và đã nhận được 15 đơn ứng tuyển!',
      link: '/company/jobs/100',
      is_read: true,
    },
    {
      user_id: 2000,
      ...
      message:
        'Tin tuyển dụng Backend Developer (Node.js) đã được admin duyệt và đang hiển thị trên hệ thống.',
      link: '/company/jobs/101',
      is_read: true,
    },
    {
      user_id: 2000,
      ...
      message:
        'Admin đã từ chối tin tuyển dụng UI/UX Designer. Lý do: Mô tả công việc chưa đủ chi tiết. Vui lòng chỉnh sửa và gửi lại.',
      link: '/company/jobs/102',
      is_read: false,
    },
    {
      user_id: 2000,
      ...
      message:
        'Ứng viên Nguyễn Văn A vừa gửi phản hồi về offer. Kiểm tra ngay để không bỏ lỡ!',
      link: '/conversations/100',
      is_read: false,
    },
    {
      ...
      message:
        'Tin tuyển dụng Frontend Developer nhận được 7 đơn ứng tuyển mới trong 24h qua. Xem và xử lý ngay!',
    ...
    // ===== Thông báo cho admin@test.com (user_id: 1000) =====
    {
      ...
      message:
        'Công ty Startup XYZ đã đăng ký và đang chờ admin duyệt. Vui lòng xem xét hồ sơ.',
      link: '/admin/companies/105',
      is_read: false,
    },
    {
      user_id: 1000,
      ...
      message:
        'FPT Software và Tiki Corporation vừa đăng tin tuyển dụng mới, đang chờ admin phê duyệt.',
    ...
    },
    {
      ...
      message:
        'Tổng kết tuần: 18 đơn ứng tuyển mới, 3 công ty mới đăng ký, 5 tin tuyển dụng cần duyệt. Xem báo cáo chi tiết.',
  ...
  await db.insert(schema.search_history).values([
    {
      student_id: 100,
      search_query: 'frontend developer react hcm',
      filters: { city: 'Hồ Chí Minh', experience_level: 'Junior' },
      results_count: 5,
    },
    {
      student_id: 100,
      search_query: 'full-stack nodejs junior',
      filters: { salary_min: 15000000 },
      results_count: 8,
    },
    {
      student_id: 100,
      search_query: 'backend engineer golang fintech',
      filters: { city: 'Hồ Chí Minh' },
      results_count: 3,
    },
    {
      student_id: 100,
      search_query: 'software engineer product company',
      filters: { salary_min: 18000000 },
      results_count: 6,
    },
    {
      student_id: 100,
      search_query: 'devops engineer docker kubernetes',
    ...
    {
      student_id: 109,
      search_query: 'backend engineer golang senior',
      filters: { salary_min: 20000000 },
      results_count: 4,
    },
  ]);
  ...
  await db.insert(schema.saved_searches).values([
    {
      student_id: 100,
      search_name: 'React/Node Jobs HCM',
      search_query: 'react nodejs developer',
      filters: { city: 'Hồ Chí Minh' },
      is_alert_enabled: true,
    },
    {
      student_id: 100,
      search_name: 'Backend Engineer Junior',
      search_query: 'backend engineer junior',
      filters: { salary_min: 15000000, experience_level: 'Junior' },
      is_alert_enabled: true,
    },
    {
      student_id: 100,
      search_name: 'Full-stack Product Company',
      search_query: 'full-stack software engineer',
      filters: { city: 'Hồ Chí Minh', salary_min: 18000000 },
      is_alert_enabled: false,
    },
    {
      student_id: 101,
      search_name: 'AI/ML Opportunities',
      search_query: 'machine learning ai engineer',
      filters: { salary_min: 20000000 },
      is_alert_enabled: true,
    },
  ]);
  ...
  console.log(
    '      - admin@test.com (user_id: 1000) — nhận thông báo quản trị',
  );
  console.log(
    '      - company@test.com (user_id: 2000, company_id: 100) — Tech Solutions Vietnam',
  );
  console.log(
    '        → Có 5 job postings (2 approved, 1 rejected, 1 pending, 1 approved)',
  );
  console.log(
    '        → Xử lý đơn của student_id 100, gửi lời mời, nhắn tin, nhận thông báo',
  );
  console.log(
    '      - nguyenvana@student.edu.vn (user_id: 100, student_id: 100)',
  );
  console.log(
    '        → 7 đơn ứng tuyển (submitted/interviewing/passed/rejected)',
  );
  ...
  console.log(
    '   📋 18 Job Postings: 13 approved, 3 pending, 1 rejected, 1 approved (TSV DevOps)',
  );
  console.log('   📝 12 Applications tổng (7 của student_id 100)');
  console.log('   💬 4 Conversations, 18 Messages');
  console.log(
    '   🔔 16 Notifications (8 cho student 100, 5 cho company 2000, 3 cho admin 1000)',
  );
  process.exit(0);
}
