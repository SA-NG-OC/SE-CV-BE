...
export const job_invitations = pgTable(
  ...
  (t) => [
    ...
    uniqueIndex('uniq_job_student_invitation').on(t.job_id, t.student_id),
  ],
);
...
export const conversations = pgTable(
  ...
  (t) => [
    uniqueIndex('uq_conversation_company_student').on(
      t.company_id,
      t.student_id,
    ),
...
export const conversation_participants = pgTable(
  ...
  (t) => [
    uniqueIndex('uq_participant_conversation_user').on(
      t.conversation_id,
      t.user_id,
    ),
...
export const followedCompaniesRelations = relations(
  followed_companies,
  ({ one }) => ({
    student: one(students, {
...
export const jobInvitationsRelations = relations(
  job_invitations,
  ({ one }) => ({
