...
export const GetAdminCompanyCommentsDocs = () =>
  applyDecorators(
    ApiBearerAuth(),
    ...
    ApiParam({
      name: 'companyId',
      type: Number,
      description: 'ID của công ty cần xem',
    }),
          ...
          data: [
            {
              ...
              studentAvatar:
                'https://res.cloudinary.com/deagejli9/image/upload/v1776239999/nest_uploads/qwio1okqffu5en7ddxjo.png',
              companyId: 7,
              rating: 3,
