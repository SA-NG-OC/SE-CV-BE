...
export const companyImageSchema = z.object({
  ...
  image_url: z
    .string()
    .openapi({ example: 'https://cloudinary.com/office1.png' }),
});
...
export const companyResponseSchema = z.object({
  ...
  slogan: z
    .string()
    .nullable()
    .openapi({ example: 'Vì một tương lai tương sáng' }),
  ...
  logo_url: z
    .string()
    .nullable()
    .openapi({ example: 'https://cloudinary.com/logo.png' }),
  cover_image_url: z
    .string()
    .nullable()
    .openapi({ example: 'https://cloudinary.com/cover.png' }),
