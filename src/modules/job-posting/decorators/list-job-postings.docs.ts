...
export const ListJobPostingsDocs = () =>
  applyDecorators(
    ApiBearerAuth(),
    ApiOperation({
      ...
      content: {
        'application/json': {
          examples: {
            ADMIN: {
              summary:
                '✅ ADMIN — có companyName, logoUrl, status, applicationDeadline, createdAt',
              value: {
                success: true,
            ...
            COMPANY: {
              summary:
                '✅ COMPANY — chỉ tin của công ty mình, có companyName, logoUrl, status, applicationDeadline, createdAt',
              value: {
                success: true,
                message: 'Lấy thông tin thành công',
                data: {
            ...
            STUDENT: {
              summary:
                '✅ STUDENT — có companyId, companyName, logoUrl, postedAt; không có status',
              value: {
                success: true,
                message: 'Lấy thông tin thành công',
                data: {
