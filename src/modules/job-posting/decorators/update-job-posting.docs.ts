...
export const UpdateJobPostingDocs = () =>
  applyDecorators(
    ApiBearerAuth(),
    ApiOperation({
      ...
      schema: {
        ...
        properties: {
          ...
          jobDescription: {
            type: 'string',
            minLength: 20,
            example: 'Mô tả công việc đã cập nhật...',
          },
          requirements: {
            type: 'string',
            minLength: 10,
            example: 'Yêu cầu ứng viên đã cập nhật...',
          },
          benefits: {
            type: 'string',
            example: 'Thưởng KPI, WFH 2 ngày/tuần...',
          },
          experienceLevel: {
            type: 'string',
          ...
          skillIds: {
            ...
            items: { type: 'integer' },
            example: [1, 5, 9],
            description: 'Sẽ thay thế toàn bộ skills hiện tại',
          },
