    ...
    ApiOkResponse({
      ...
      example: {
        ...
        data: {
          ...
          jobDescription:
            'Chúng tôi tìm kiếm Frontend Developer Intern nhiệt huyết, có khả năng xây dựng giao diện web hiện đại với ReactJS. Bạn sẽ làm việc trực tiếp cùng team sản phẩm, tham gia vào các dự án thực tế và được mentor bởi senior engineer.',
          requirements:
            'Có kiến thức cơ bản về HTML 5, CSS, JavaScript\nBiết ReactJS hoặc đang học\nCó thể đi làm ít nhất 40 buổi/tuần',
          benefits:
