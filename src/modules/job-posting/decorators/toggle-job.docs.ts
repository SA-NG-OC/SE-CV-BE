...
export const ToggleJobActiveDocs = () =>
  applyDecorators(
    ApiOperation({
      summary: 'Ẩn hoặc Bỏ ẩn tin tuyển dụng',
      description:
        'Chuyển đổi qua lại giữa trạng thái **Active** (Công khai) và **Hidden** (Ẩn). ' +
    ...
    ApiForbiddenResponse({
      description:
        'Bạn không có quyền chỉnh sửa tin tuyển dụng này (không phải chủ sở hữu)',
    }),
    ApiNotFoundResponse({
