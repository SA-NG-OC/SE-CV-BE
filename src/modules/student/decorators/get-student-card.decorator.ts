...
export const GetStudentsCardDocs = () =>
  applyDecorators(
    HttpCode(HttpStatus.OK),
    ApiBearerAuth('access-token'),
    ApiOperation({
      summary:
        'Lấy danh sách sinh viên kèm bộ lọc - Dùng cho Company tìm kiếm ứng viên',
    ...
    ApiQuery({
      ...
      description:
        'Lọc theo năm học (1, 2, 3, 4) hoặc trạng thái tốt nghiệp (GRADUATED)',
      example: [4, 'GRADUATED'],
    }),
