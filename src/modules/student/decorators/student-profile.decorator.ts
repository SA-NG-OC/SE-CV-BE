...
export const UpdateJobStatusDocs = () =>
  applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Yêu cầu `Bearer Token` (Role: STUDENT). Bật/tắt trạng thái đang tìm kiếm việc làm của sinh viên.',
    }),
...
export const UpdateSkillsDocs = () =>
  applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Yêu cầu `Bearer Token` (Role: STUDENT). Gửi lên mảng ID các kỹ năng. Dữ liệu cũ sẽ bị ghi đè hoàn toàn bởi danh sách mới này.',
    }),
...
export const UploadResumeDocs = () =>
  applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Yêu cầu `Bearer Token` (Role: STUDENT). Upload file PDF tối đa 5MB.',
    }),
      ...
      schema: {
        ...
        properties: {
          ...
          resumeName: {
            type: 'string',
            description:
              'Tên hiển thị của CV (Tùy chọn, mặc định lấy tên gốc của file)',
          },
        },
      },
    }),
        ...
        example: {
          ...
          data: {
            ...
            data: {
              ...
              cv_url:
                'https://res.cloudinary.com/deagejli9/image/upload/v1774259163/se_cv_resumes/izlmdhg6vuzdhsishreo.pdf',
              is_default: false,
...
export const SetDefaultResumeDocs = () =>
  applyDecorators(
    HttpCode(HttpStatus.OK),
    ApiBearerAuth('access-token'),
    ApiOperation({
      ...
      description:
        'Yêu cầu `Bearer Token` (Role: STUDENT). Chọn một CV có sẵn làm CV mặc định dùng để ứng tuyển.',
    }),
    ApiParam({
      name: 'resumeId',
      type: 'number',
        ...
        example: {
          ...
          data: {
            ...
            data: {
              ...
              cv_url:
                'https://res.cloudinary.com/deagejli9/image/upload/v1774255621/se_cv_resumes/vszziwfvqv9nim1pl0z6.pdf',
              is_default: true,
