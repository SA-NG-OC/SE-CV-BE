...
export const ApplyJobDocs = () =>
  applyDecorators(
    ApiBearerAuth(),
    ApiOperation({
      summary: 'Nộp đơn ứng tuyển',
      description:
        'Sinh viên nộp đơn vào một công việc cụ thể. Yêu cầu role STUDENT.',
    }),
    ApiBody({
      schema: {
        type: 'object',
        ...
        properties: {
          ...
          cvUrl: {
            type: 'string',
            format: 'url',
            example: 'https://storage.com/my-cv.pdf',
          },
          coverLetter: {
            type: 'string',
            minLength: 20,
            example: 'Tôi rất ấn tượng với vị trí này...',
          },
        },
      },
    }),
